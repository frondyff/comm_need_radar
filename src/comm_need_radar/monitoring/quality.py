...
def role_activity_rows() -> list[dict[str, str]]:
    return [
        {"date":"2026-06-11","owner":"Chloe","role":"Product / project lead","activity":"Locked MVP scope around synthetic data, local run, and optional cloud path","output":"docs/archive/project-definition.md","decision_or_blocker":"Real public data deferred","next_step":"Open implementation issues"},
