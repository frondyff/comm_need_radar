...
SERVICES_MASTER_PATH = PROCESSED_DIR / "services_master.csv"
AREA_BOUNDARIES_PATH = PROJECT_ROOT / "frontend" / "public" / "geo" / "areas.geojson"
SCORING_FORMULA_MANIFEST_PATH = PROCESSED_DIR / "scoring_formula_manifest.json"
