...
3. **Architecture** — use `docs/archive/production-web-architecture.md`.
...
9. **Bias and limitations** — use `docs/reference/scoring/scoring-validation-2026-07-27.md`.
10. **User-testing findings** — populate from `docs/reference/submission/user-testing-plan.md`;
