...
- Guided chatbot: click through a predefined set of questions (e.g. area
  demographics, service demand); answers are computed live from Supabase
  data, not hardcoded
...
| `page_events` | Analytics — passive events (e.g., page view, filter clicked, map opened) |
